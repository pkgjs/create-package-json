...
### [1.2.3](https://github.com/wesleytodd/create-package-json/compare/v1.2.2...v1.2.3) (2026-01-22)


### Bug Fixes

* only prompt for workspace root when it looks like it might be a monorepo ([#247](https://github.com/wesleytodd/create-package-json/issues/247)) ([d31d0b3](https://github.com/wesleytodd/create-package-json/commit/d31d0b3e932c50d6df2b3d91bebb1ede791840c7))
